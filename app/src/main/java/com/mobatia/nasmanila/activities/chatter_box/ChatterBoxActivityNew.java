...
import com.mobatia.nasmanila.activities.chatter_box.adapter.ChatterBoxRecyclerAdapterNew;
 ...
 */
public class ChatterBoxActivityNew extends Activity implements
...
//        bannerImagePager= (ViewPager) findViewById(R.id.bannerImageViewPager);
        ...
        headermanager = new HeaderManager(ChatterBoxActivityNew.this, tab_type);
...
//                        sendEmailToStaff(URL_SEND_EMAIL_TO_STAFF);
    ...
    public void onClick(View v) {
        ...
        Intent mintent = new Intent(ChatterBoxActivityNew.this, FullscreenWebViewActivityNoHeader.class);
                                ...
                                if (responsCode.equals(RESPONSE_SUCCESS)) {
                                    ...
                                    if (statusCode.equals(STATUS_SUCCESS)) {
                                        ...
                                        if (!bannerImage.equalsIgnoreCase("")) {
                                            Glide.with(mContext).load(AppUtils.replace(bannerImage)).placeholder(R.drawable.default_bannerr).centerCrop().into(bannerImagePager);
                                        ...
                                        if (dataArray.length() > 0) {
                                            ...
                                            mChatterBoxListRecyclerView.setAdapter(new ChatterBoxRecyclerAdapterNew(mContext, mTermsCalendarListArray));
