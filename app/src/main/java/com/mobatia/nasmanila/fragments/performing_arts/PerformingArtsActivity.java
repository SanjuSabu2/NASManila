...
public class PerformingArtsActivity extends Activity implements AdapterView.OnItemClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_performingart_list);
        mContext = this;
        initialiseUI();
    }
    private void initialiseUI() {
        relativeHeader = (RelativeLayout) findViewById(R.id.relativeHeader);
        headermanager = new HeaderManager(PerformingArtsActivity.this, PERFORMING_ARTS);
        ...
        mListView = (RecyclerView)findViewById(R.id.mPerformingArtListView);
...
//											mListView.setAdapter(new CustomSecondaryAdapter(getActivity(), mListViewArray));
                                            mListView.setAdapter(new PerformingArtsListAdapter(mContext, mListViewArray));
